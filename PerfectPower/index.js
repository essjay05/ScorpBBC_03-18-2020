...
// Perfect power is a classification of positive integers:
    ...
    // of another positive integer. More formally, n is a perfect power if there exist
    // natural numbers m > 1, and k > 1 such that m to the K power = n.

// Task: check whether a given integer is a perfect power.  If yes, return a pair
    // m and k with m to the k power = n as proof.  Otherwise return Nothing, Nil, 
    // null, NULL, None or your language's equivalent.
...
// Examples:
    ...
    //         Test.assertSimilar(isPP(5), null, "5 isn't a perfect number");
    //     });
    // });
